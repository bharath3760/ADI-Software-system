package com.example.googlemapswork;
...
public class TrackingActivity extends AppCompatActivity implements OnMapReadyCallback, android.location.LocationListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tracking);mPager = (ViewPager)findViewById(R.id.image_slider_pager);
    ...
    public void statusChange(){
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(DownloadManager.Request.Method.POST, Bitmap.Config.SHOW_RIDER_LOCATION_AGAINST_LATLONG, jsonObject1, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
